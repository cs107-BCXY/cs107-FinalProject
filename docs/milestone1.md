...
For elementary functions `sin`, `sqrt`, `log`, `exp`, etc.. mentioned in the prompt, the package can rely on the [`SymPy`](https://www.sympy.org/en/index.html) module as it holds a well curated list of basic functions for differentiation.
